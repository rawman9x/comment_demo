...
<div class="comments-app">
    ...
    <!-- Comments List -->
    <div class="comments" v-if="comments" v-for="(comment,index) in commentsData" v-bind:key="index">
        <!-- Comment -->
        <div v-if="!spamComments[index] || !comment.spam" class="comment">
            ...
            <div v-if="comment.replies">
                <div class="comments" v-for="(replies,index2) in comment.replies" v-bind:key="index2">
